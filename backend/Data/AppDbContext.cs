...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Trip>(entity =>
        {
            ...
            entity.Property(trip => trip.CoverImageUrl)
                .HasMaxLength(2048);
        ...
        modelBuilder.Entity<TripStep>(entity =>
        {
            ...
            entity.Property(step => step.GoogleMapsUrl)
                .HasMaxLength(2048);

            entity.Property(step => step.ExternalUrl)
                .HasMaxLength(2048);

            entity.Property(step => step.TicketImageUrl)
                .HasMaxLength(2048);

            entity.Property(step => step.PlaceImageUrl)
                .HasMaxLength(2048);
            ...
            entity.Property(step => step.UpdatedAt)
                .IsRequired();
